...
function init() {
   ...
   // $("#cboTipoComprobanteIng").change(VerNumSerie);
	...
	$("#btnAgregarArt").click(function(e){
		...
		opt.each(function() {
			AgregarDetalle($(this).val(), $(this).attr("data-nombre"), "", "", "", "1", "1", "1", "1", "1", "1", "1", "1", "1");
		})
...
//**************FIN COMBO BOX**************
	function Agregar(){
       ...
       var prec_ventaP = document.getElementsByName("txtPrecioVentaP");
        var prec_ventaP2 = document.getElementsByName("txtPrecioVentaP2");
        var prec_ventaP3 = document.getElementsByName("txtPrecioVentaP3");
        var prec_ventaP4 = document.getElementsByName("txtPrecioVentaP4");
        var prec_ventaP5 = document.getElementsByName("txtPrecioVentaP5");
        ...
        for (var i = 0; i < stock_ing.length; i++) {
            if (stock_ing[i].value !== "") {
                ...
                1,
                	/*prec_ventaD[i].value, */
                	 prec_ventaP[i].value, 
                	 prec_ventaP2[i].value, 
                	 prec_ventaP3[i].value,
                	 prec_ventaP4[i].value, 
                	 prec_ventaP5[i].value);
            }
        }
...
if ($("#txtIdProveedor").val() != "" ) {
  ...
  GetIdIngreso();
    ...
    */
    ...
    function AgregarDetalle(idart, nombre, codigo, serie, descripcion, stock_ing, stock_act, p_compra, p_ventaD, p_ventaP, p_ventaD2, p_ventaD3, p_ventaD4, p_ventaD5) {
        var detalles = new Array(idart, nombre, codigo, serie, descripcion, stock_ing, stock_act, p_compra, p_ventaD, p_ventaP2, p_ventaD2, p_ventaD3, p_ventaD4, p_ventaD5);
        elementos.push(detalles);
        ConsultarDetalles();
    }

    function AgregarDetalleRegistrar(idart, codigo, serie, descripcion, stock_ing, stock_act, p_compra, p_ventaD, p_ventaP, p_ventaP, p_ventaD2, p_ventaD3, p_ventaD4, p_ventaD5) {
        var detallesReg = new Array(idart, codigo, serie, descripcion, stock_ing, stock_act, p_compra, p_ventaD, p_ventaP, p_ventaP, p_ventaD2, p_ventaD3, p_ventaD4, p_ventaD5);
...
function ConsultarDetalles() {
        ...
        for (var pos in data) {
            $("table#tblDetalleIngreso").append("<tr><td>" + data[pos][1] + " <input class='form-control' type='hidden' name='txtIdArticulo' id='txtIdArticulo[]' value='" + data[pos][0] + "' /></td><td><input class='form-control' type='text' disabled  name='txtCodgo' id='txtCodgo[]' value='" + data[pos][2] + "' /></td><td><input class='form-control' type='hidden' name='txtSeries' onkeyup='Modificar(" + pos + ");' id='txtSeries[]'  value='" + data[pos][3] + "' /></td><td><input class='form-control' type='text' name='txtDescripcion' onkeyup='Modificar(" + pos + ");' id='txtDescripcion[]' style='display:none;'  value='" + data[pos][4] + "' /></td><td><input class='form-control' type='text' onkeypress='return justNumbers(event);' name='txtStockIng' id='txtStockIng[]'   value='" + data[pos][5] + "' onkeyup='calcularTotal(" + pos + ");' required /></td><td><input class='form-control' type='text' onkeypress='return onKeyDecimal(event,this);' name='txtPrecioComp' id='txtPrecioComp[]'  value='" + data[pos][6] + "' onkeyup='calcularTotal(" + pos + ");' required /></td><td><input class='form-control' type='text' onkeypress='return onKeyDecimal(event,this);' onkeyup='Modificar(" + pos + ");' name='txtPrecioVentaP' id='txtPrecioVentaP[]' value='" + data[pos][8] + "' required /></td><td><input class='form-control' type='text' onkeypress='return onKeyDecimal(event,this);' onkeyup='Modificar(" + pos + ");' name='txtPrecioVentaP2' id='txtPrecioVentaP2[]' value='" + data[pos][9] + "' required /></td><td><input class='form-control' type='text' onkeypress='return onKeyDecimal(event,this);' onkeyup='Modificar(" + pos + ");' name='txtPrecioVentaP3' id='txtPrecioVentaP3[]' value='" + data[pos][10] + "' required /></td><td><input class='form-control' type='text' onkeypress='return onKeyDecimal(event,this);' onkeyup='Modificar(" + pos + ");' name='txtPrecioVentaP4' id='txtPrecioVentaP4[]' value='" + data[pos][11] + "' required /></td><td><input class='form-control' type='text' onkeypress='return onKeyDecimal(event,this);' onkeyup='Modificar(" + pos + ");' name='txtPrecioVentaP5' id='txtPrecioVentaP5[]' value='" + data[pos][12] + "' required /></td><td WIDTH='100'><button type='button' data-toggle='tooltip' title='Quitar Articulo del detalle' onclick='eliminarDetalle(" + pos + ")' class='btn btn-danger'><i class='fa fa-remove' ></i> </button> <button type='button' data-toggle='tooltip' title='Pulse aqui para agregar mas filas de este articulo' onclick='AgregarDetalle(" + data[pos][0] + ",\"" + data[pos][1] +"\",\"" + data[pos][2] + "\",\"" + "" + "\",\"" + data[pos][4] + "\",\"" + data[pos][5] + "\",\"" + data[pos][6] + "\",\"" + "" + "\",\"" + data[pos][8] + "\",\"" + data[pos][9] + "\",\"" + data[pos][10] + "\",\"" + data[pos][11] + "\",\"" + data[pos][12] + "\",\"" + pos + "\")' class='btn btn-success'><i class='fa fa-plus' ></i> </button></td></tr>");
        }
        calcularIgv();
        calcularSubTotal();
        calcularTotal();
...
function ListadoIngresos(){
    ...
    function calcularMargen(posi){
        ...
        var data = JSON.parse(objinit.consultar());
        for (var pos in data) {
        utilidad = parseFloat(0);

        var res = utilidad + parseInt(data[pos][6]);
        prec_ventaP[pos].value=(res);
    ...
    function Modificar(pos){
      ...
      //  elementos[pos][7] = prec_ventaD[pos].value;
        elementos[pos][8] = prec_ventaP[pos].value;
        elementos[pos][9] = prec_ventaP2[pos].value;
        elementos[pos][10] = prec_ventaP3[pos].value;
        elementos[pos][11] = prec_ventaP4[pos].value;
          elementos[pos][12] = prec_ventaP5[pos].value;
    ...
    function Agregar(id, art,margen, codigo){
        AgregarDetalleCarrito(id, art, codigo, "", "", "1", "1", margen, "1", "1");
    }
